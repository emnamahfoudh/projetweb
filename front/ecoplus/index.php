...
<html lang="en">
   ...
   <body>
         ...
         <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
               <div class="navbar-nav">
                  ...
                  <a class="nav-item nav-link" href="evenement.php">EVENEMENTS</a>
               ...
               <div class="carousel-inner">
                  <div class="carousel-item active">
                     <div class="container">
                        <div class="row">
                           <div class="col-md-6">
                              <h1 class="banner_taital">on n'a q'une terre <span style="color:  #0b330d;">pourquoi la detruire!</span></h1>
                           </div>
                           <div class="col-md-6">
                              <div><img src="images/terre.jpg" class="image_1"></div>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="carousel-item">
                     <div class="container">
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div><img src="images/terre.jpg" class="image_1"></div>
                              <img src="terre.jpg" height="150" width="auto">
                           </div>
                        </div>
                     </div>
                  </div>
      ...
      <div class="choose_section">
         <div class="container">
            <h1 class="choose_taital">pourquoi nous choisir?</h1>
            <p class="choose_text">Notre site environnemental se démarque par l'offre de formations de qualité supérieure mais nous organisons également des forums pour partager des idées et sensibiliser les gens à sauver la planète. Rejoignez notre communauté dès maintenant.
               </p>
            <div class="choose_section_2">
               <div class="choose_left">
                  ...
                  <div class="choose_right_main">
                     <h1 class="satisfied_text">99%<br><span class="satisfied_text_1">participants SATISFAITS</span></h1>
                  </div>
               </div>
               <div class="choose_middle">
                  ...
                  <div class="choose_right_main">
                     <h1 class="satisfied_text">40+<br><span class="satisfied_text_1">formations excellentes</span></h1>
                  </div>
               </div>
               <div class="choose_middle_1">
                  ...
                  <div class="choose_right_main">
                     <h1 class="satisfied_text">900+<br><span class="satisfied_text_1">participants</span></h1>
                  </div>
               </div>
               <div class="choose_right">
                  ...
                  <div class="choose_right_main">
                     <h1 class="satisfied_text">190+<br><span class="satisfied_text_1">visites quotidiennes</span></h1>
                  </div>
               </div>
            </div>
         </div>
      ...
      <!-- shop section start -->
               ...
               <div class="carousel-item">
                  <div class="container">
                     <h1 class="shop_taital">ecoplus</h1>
                     <p class="shop_text">votre meilleur choix pour un engagement environnemental concret</p>
                     <div><img src="images/img-3.png" class="image_3"></div>
                  </div>
               </div>
               <div class="carousel-item">
                  <div class="container">
                     <h1 class="shop_taital">ecolplus</h1>
                     <p class="shop_text">votre meilleur choix pour un engagement environnemental concret</p>
                     <div><img src="images/img-3.png" class="image_3"></div>
                  </div>
               </div>
    ...
    <div class="contact_section layout_padding">
      <div class="container-fluid">
         <div class="row">
            <div class="col-md-6">
               <div class="mail_main">
                  <h1 class="contact_taital">Contactez nous</h1>
                  <form action="/action_page.php">
                     ...
                     <div class="form-group">
                        <input type="text" class="email-bt" placeholder="Sujet" name="Email">
                     </div>
                     <div class="form-group">
                  ...
                  <div class="send_btn">
                     <div class="main_bt"><a href="#">envoyer</a></div>
                  </div>
               </div>
            </div>
            <div class="col-md-6">
               <div class="map_main">
                  <div class="map-responsive">
                     <iframe src="https://www.google.com/maps/dir/36.9064038,10.184358/La+petite+Ariana,+Cebalat+Ben+Ammar,+Tunisie/@36.9028731,10.1788152,16z/data=!3m1!4b1!4m8!4m7!1m0!1m5!1m1!1s0x12e2cb763f2120bb:0xc3e79593db50c2e8!2m2!1d10.1857342!2d36.9006591?hl=fr" width="600" height="600" frameborder="0" style="border:0; width: 100%;" allowfullscreen=""></iframe>
                  </div>
               </div>
            </div>
         </div>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     ...
                     <div class="footer_links">
                        <ul>
                           ...
                           <li><a href="services.php">FORUM</a></li>
                           <li><a href="pricing.php">FORMATION</a></li>
                           <li><a href="pricing.php">EVENEMENTS</a></li>
                           <li><a href="contact.php">RESSOURCES MATERIELLES</a></li>
                        </ul>
                     </div>
                  </div>
                  <div class="col-lg-3 col-sm-6">
